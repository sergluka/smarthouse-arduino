...
// to increase the chance of getting a packet across, call this function instead of send_message
// and it handles all the ACK requesting/retrying for you :)
// The only twist is that you have to manually listen to ACK requests on the other side and send_message back the ACKs
...
void RFM69::readAllRegs()
{
  ...
  {
    select();
    SPI.transfer(regAddr & 0x7F); // send_message address + r/w bit
