...
void motion(){
  ...
  if (randNumber <= 50) {
    ...
    send_message(msg_S_MOTION_T.set(0));
  }
...
void smoke(){
  ...
  if (randNumber <= 50) {
    ...
    Serial.print("System is: " );
    Serial.println((isArmed ? "Armed":"Disarmed"));
    send_message(msg_S_SMOKE_A.set(isArmed));
  #endif
...
void light(){
  ...
  send_message(msg_S_LIGHT.set(isLightOn));
...
void dimmer(){
  ...
  send_message(msg_S_DIMMER.set(dimmerVal));
...
void cover(){
  ...
  if (coverState == 1){
      ...
      send_message(msg_S_COVER_D.set(0));
  }else{
      Serial.println("Idle");
...
void temp(){
  ...
  send_message(msg_S_TEMP.set(map(randNumber,1,100,0,45)));
...
void hum(){
  ...
  send_message(msg_S_HUM.set(randNumber));
...
void baro(){
  ...
  send_message(msg_S_BARO_F.set(weather[forecast]));
...
void wind(){
  ...
  send_message(msg_S_WIND_G.set(randNumber+10));
...
void rain(){
  ...
  send_message(msg_S_RAIN_R.set(randNumber/60,1));
...
void uv(){
  ...
  send_message(msg_S_UV.set(map(randNumber,1,100,0,15)));
...
void weight(){
  ...
  send_message(msg_S_WEIGHT.set(map(randNumber,1,100,0,150)));
...
void power(){
  ...
  Serial.print("KWH is: " );
  Serial.println(map(randNumber,1,100,0,150));  
  send_message(msg_S_POWER_K.set(map(randNumber,1,100,0,150)));
...
//  send_message(msg_S_HEATER_STATUS.set(heater_status));
...
void distance(){
  ...
  send_message(msg_S_DISTANCE.set(map(randNumber,1,100,0,150)));
...
void light_level(){
  ...
  send_message(msg_S_LIGHT_LEVEL.set(map(randNumber,1,100,0,150)));
...
void lock(){
  ...
  send_message(msg_S_LOCK.set(isLocked));
...
void ir(){
  ...
  send_message(msg_S_IR_S.set(irVal));
...
void water(){
  ...
  send_message(msg_S_WATER_V.set(map(randNumber,1,100,0,150)));
...
void air(){
  ...
  send_message(msg_S_AIR_QUALITY.set(randNumber));
...
void dust(){
  ...
  send_message(msg_S_DUST.set(randNumber));
...
void scene(){
  ...
  if(sceneValPrevious != sceneVal){
    send_message(msg_S_SCENE_CONTROLLER_OF.set(sceneValPrevious));
...
void rgbLight(){
  ...
  Serial.println(map(randNumber,1,100,0,150));  
  send_message(msg_S_RGB_LIGHT_V_WATT.set(map(randNumber,1,100,0,150)));
...
void rgbwLight(){
  ...
  Serial.println(map(randNumber,1,100,0,150));  
  send_message(msg_S_RGBW_LIGHT_V_WATT.set(map(randNumber,1,100,0,150)));
...
void color(){
  ...
  send_message(msg_S_COLOR_SENSOR_V_RGB.set(colorState.c_str()));
...
//  String hvac_Speed       = "Normal";
  ...
  send_message(msg_S_HVAC_V_HVAC_SPEED.set(hvac_Speed.c_str()));
...
void multimeter(){
  ...
  Serial.println(volt);
  send_message(msg_S_MULTIMETER_V_VOLTAGE.set(volt));
...
void moisture(){
  ...
  send_message(msg_S_MOISTURE.set(randNumber));
}
#endif
...
void custom(){
  ...
  send_message(msg_S_CUSTOM_5.set(randNumber));
